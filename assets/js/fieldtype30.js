function newFieldtype()
{
	...
	var td_08 = d.createElement('td');
		...
		td_08.align = 'left';
		td_08.innerHTML = '<input type="text" name="element['+next_inc+'][fieldtitle]" size="30" value=""/>';
...
function changeElement(attribute_id, fieldType){
	...
	switch (fieldType){
		...
		case 'selected':
            ...
            console.log($('fieldType_tr_'+attribute_id + '_0'));
